                        ...
                        <ul className="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <Link to="/#" className="has-arrow waves-effect">
                                    ...
                                    <span className="ml-1">{this.props.t('Jobs')}</span>
                                </Link>
                                <ul className="sub-menu" aria-expanded="false">
                                    <li><Link to="jobs">{this.props.t('All Categories')}</Link></li>
                                    <li><Link to="youtube">{this.props.t('YouTube')}</Link></li>
                                    <li><Link to="youtube">{this.props.t('Vimeo')}</Link></li>
                                    <li><Link to="youtube">{this.props.t('Music')}</Link></li>
                                    <li><Link to="youtube">{this.props.t('Pictures')}</Link></li>
                                    <li><Link to="youtube">{this.props.t('History')}</Link></li>
                                    <li><Link to="youtube">{this.props.t('Sports Trivia')}</Link></li>
                                </ul>
                            </li>
